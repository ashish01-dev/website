    ...
    <div className="min-h-screen" style={{ fontFamily: "'DM Sans', sans-serif", background: 'var(--c-bg-gradient)' }}>
      ...
      <main className="max-w-[700px] mx-auto px-5 py-16 md:py-24">
        ...
        <div className="space-y-8 text-[14px] leading-relaxed" style={{ color: 'var(--c-text-secondary)' }}>
          <section>
            <h2 className="text-[18px] font-semibold mb-3" style={{ color: 'var(--c-text)' }}>1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-[18px] font-semibold mb-3" style={{ color: 'var(--c-text)' }}>2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-[18px] font-semibold mb-3" style={{ color: 'var(--c-text)' }}>3. User Accounts</h2>
          ...
          <section>
            <h2 className="text-[18px] font-semibold mb-3" style={{ color: 'var(--c-text)' }}>4. Data Storage &amp; Sync</h2>
          ...
          <section>
            <h2 className="text-[18px] font-semibold mb-3" style={{ color: 'var(--c-text)' }}>5. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-[18px] font-semibold mb-3" style={{ color: 'var(--c-text)' }}>6. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-[18px] font-semibold mb-3" style={{ color: 'var(--c-text)' }}>7. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-[18px] font-semibold mb-3" style={{ color: 'var(--c-text)' }}>8. Termination</h2>
          ...
          <section>
            <h2 className="text-[18px] font-semibold mb-3" style={{ color: 'var(--c-text)' }}>9. Contact</h2>
