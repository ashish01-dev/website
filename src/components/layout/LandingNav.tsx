    ...
    <nav className="relative max-w-[1100px] mx-auto w-full px-[40px] py-[28px] max-md:px-5">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-9">
          <Link href="/" className="text-sm font-normal hover:opacity-100 transition-opacity" style={{ opacity: active ? 0.65 : 1, color: 'var(--c-text)' }}>Home</Link>
          <Link href="/features" className="text-sm font-normal hover:opacity-100 transition-opacity" style={{ opacity: 0.65, color: 'var(--c-text)' }}>Features</Link>
          <Link href="/pricing" className="text-sm font-normal hover:opacity-100 transition-opacity" style={{ opacity: active === 'pricing' ? 1 : 0.65, color: active === 'pricing' ? 'var(--c-blue)' : 'var(--c-text)' }}>Pricing</Link>
          <Link href="/about" className="text-sm font-normal hover:opacity-100 transition-opacity" style={{ opacity: active === 'about' ? 1 : 0.65, color: active === 'about' ? 'var(--c-blue)' : 'var(--c-text)' }}>About</Link>
        </div>
          ...
          {user ? (
            <div ref={profileRef} className="relative">
              <button onClick={() => setShowProfileDropdown(!showProfileDropdown)}
                ...
                <span className="text-sm font-medium max-w-[120px] truncate" style={{ color: 'var(--c-text)' }}>{user.name}</span>
              </button>
              {showProfileDropdown && (
